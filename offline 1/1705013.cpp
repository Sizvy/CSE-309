...
int main()
{
    ...
    if(newfile.is_open())
    {
        ...
        SymbolTable *symTb = new SymbolTable(size);
        while(getline(newfile, line))
        {
            ...
            if(results[0]=="I")
            {
                symTb->insertSymbol(results[1],results[2]);
            }
            else if(results[0]=="S")
            {
                symTb->EnterScope(size);
            }
            else if(results[0]=="E")
            {
                symTb->ExitScope();
            ...
            {
                symTb->Lookup(results[1]);
            }
            else if(results[0]=="D")
            {
                symTb->RemoveSymbol(results[1]);
            }
            else if(results[0]=="P")
            {
                if(results[1]=="C")
                {
                    symTb->PrintCurrentScope();
                }
                else
                {
                    symTb->PrintAllScope();
